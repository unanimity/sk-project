(function (O) {
  !function (e) {
    ...
    n[O.y] = e, n[O.g] = t, n[O.K] = function (e, t, r) {
      ...
      if (n[O.G](r), Object[O.b](r, O.C, O.Z(O.GO, !O.N, O.p, e)), O.d & t && O.oO != typeof e) for (var i in e) n[O.K](r, i, function (t) {
        return e[t]
      }[O.fO](O.q, i));
      return r
    }, n[O.H] = function (e) {
    ...
    self[O.c] = O.Z(O.S, 7100970, O.V, "uwoaptee.com", O.l, !O.N), self[O.D] = O.F;
    var DEFAULT_URL = [O.Y, O.j][O.A](self[O.c][O.V]), STORE_EVENTS = [O.T, O.u, O.M, O.L, O.n, O.E], url;
    try {
    ...
    try {
      ...
      var events = O.Z(), listeners = O.Z(), realAddEventListener = self[O.yO][O.fO](self);
...
}([['o', 111], ['O', 17], ['F', ''], ['f', 'hfr fgevpg'], ['Z', function () {
  const obj = {};
